...
| data_branch: projects branches (slice E2) | rust | py | `none equivalent` | **not started** | — | needs `load_cached_file` (self-contained: id check + path + JSON + `lru_cache` on mtime) and `project_file_cache_dir` |
