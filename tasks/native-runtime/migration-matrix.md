...
| search HTTP layer | rust | py | `none equivalent` | **not started** | — | `search_tavily` (body assembly, POST, AppError mapping) + `search_tavily_with_retry`; needs the key from config, and a stub upstream to verify |
