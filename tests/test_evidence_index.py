...
def test_evidence_index_lists_edge_router_stabilization() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/edge-router-v2.9.1.json" in index
...
def test_evidence_index_lists_context_taint() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/context-taint-v2.9.1.json" in index
...
def test_evidence_index_lists_workspace_core() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/workspace-v2.9.1.json" in index
...
def test_evidence_index_lists_media_layer() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/media-v2.9.1.json" in index
    assert "evals/reports/media-v2.9.1.json" in index
...
def test_evidence_index_lists_browser_control() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/browser-v2.9.1.json" in index
    assert "evals/reports/browser-v2.9.1.json" in index
...
def test_evidence_index_lists_automation_runtime() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/automation-v2.9.1.json" in index
    assert "evals/reports/automation-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_system() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skills-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_workbench_ui() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skills-ui-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_builder() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-builder-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_packs() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-packs-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_eval_dashboard() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-eval-dashboard-v2.9.1.json" in index
    assert "evals/reports/skills-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_versioning() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-versioning-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_analytics() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-analytics-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_security() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-security-v2.9.1.json" in index
...
def test_evidence_index_lists_skill_catalog() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-catalog-v2.9.1.json" in index
