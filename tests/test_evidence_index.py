...
def test_evidence_index_lists_edge_router_stabilization() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/edge-router-v4.2.2.json" in index
...
def test_evidence_index_lists_context_taint() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/context-taint-v4.2.2.json" in index
...
def test_evidence_index_lists_semantic_cache_benchmark() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/semantic-cache-onnx-v4.2.2.json" in index
...
def test_evidence_index_lists_rag_document_preparation() -> None:
    ...
    assert "docs/evidence/rust-sidecar-performance-v4.2.2.json" in index
...
def test_evidence_index_lists_rag_vector_binary_transport() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/rag-vector-binary-parity-v4.2.2.json" in index
...
def test_evidence_index_lists_workspace_core() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/workspace-v4.2.2.json" in index
...
def test_evidence_index_lists_media_layer() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/media-v4.2.2.json" in index
    assert "evals/reports/media-v4.2.2.json" in index
...
def test_evidence_index_lists_browser_control() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/browser-v4.2.2.json" in index
    assert "evals/reports/browser-v4.2.2.json" in index
...
def test_evidence_index_lists_frontend_browser_smoke() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/frontend-browser-v4.2.2.json" in index
...
def test_evidence_index_lists_frontend_bundle_decomposition() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/frontend-bundle-v4.2.2.json" in index
...
def test_evidence_index_lists_automation_runtime() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/automation-v4.2.2.json" in index
    assert "evals/reports/automation-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_system() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skills-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_workbench_ui() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skills-ui-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_builder() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-builder-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_packs() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-packs-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_eval_dashboard() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-eval-dashboard-v4.2.2.json" in index
    assert "evals/reports/skills-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_versioning() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-versioning-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_analytics() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-analytics-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_security() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-security-v4.2.2.json" in index
...
def test_evidence_index_lists_skill_catalog() -> None:
    index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
    assert "docs/evidence/skill-catalog-v4.2.2.json" in index
