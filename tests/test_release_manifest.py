...
def test_build_manifest_has_required_fields(tmp_path: Path) -> None:
    ...
    assert "docs/evidence/edge-router-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/workspace-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/context-taint-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/media-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/browser-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/automation-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skills-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skills-ui-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-builder-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-packs-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-eval-dashboard-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-versioning-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-analytics-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-security-v2.9.1.json" in manifest["evidence"]
    assert "docs/evidence/skill-catalog-v2.9.1.json" in manifest["evidence"]
    assert "evals/reports/skills-v2.9.1.json" in manifest["evidence"]
    assert "evals/reports/media-v2.9.1.json" in manifest["evidence"]
    assert "evals/reports/browser-v2.9.1.json" in manifest["evidence"]
    assert "evals/reports/automation-v2.9.1.json" in manifest["evidence"]
