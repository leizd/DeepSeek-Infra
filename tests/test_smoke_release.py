...
def test_offline_mode_runs_doctor_evals_and_agent_only() -> None:
    ...
    assert stage_commands["browser_control"][-2:] == ["--version", "4.1.1"]
    assert stage_commands["browser_eval"][-2:] == ["--version", "4.1.1"]
    assert stage_commands["automation_runtime"][-2:] == ["--version", "4.1.1"]
    assert stage_commands["automation_eval"][-2:] == ["--version", "4.1.1"]
