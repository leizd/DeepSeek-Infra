...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_release_version_sync_current(self) -> None:
        ...
        self.assertIn("version-4.0.0--rc.2-blue", readme)
        self.assertIn('app_version: str = "4.0.0-rc.2"', config)
        self.assertIn("deepseek-infra:4.0.0-rc.2", dockerfile)
        self.assertIn('org.opencontainers.image.version="4.0.0-rc.2"', dockerfile)
        self.assertIn('versionName "4.0.0-rc.2"', build_gradle)
        self.assertIn("versionCode 400002", build_gradle)
        self.assertIn('<meta name="deepseek-infra-version" content="4.0.0-rc.2" />', frontend)
        self.assertIn("## [4.0.0-rc.2] - Hybrid Runtime Release Freeze", changelog)
        self.assertIn("Personal AI Runtime GA", readme)
        self.assertIn("python scripts/smoke_ga.py --offline --out docs/evidence/ga-v4.0.0-rc.2.json", ci)
        self.assertIn("python scripts/preflight_release.py --version 4.0.0-rc.2 --ga", ci)
    ...
    def test_release_docs_are_registered(self) -> None:
        ...
        self.assertIn("docs/evidence/ga-v4.0.0-rc.2.json", evidence_index)
    ...
    def test_required_evidence_json_is_current_and_passes(self) -> None:
        required = (
            "docs/evidence/ga-v4.0.0-rc.2.json",
            "docs/evidence/workspace-v4.0.0-rc.2.json",
            "docs/evidence/edge-router-v4.0.0-rc.2.json",
            "docs/evidence/media-v4.0.0-rc.2.json",
            "docs/evidence/browser-v4.0.0-rc.2.json",
            "docs/evidence/automation-v4.0.0-rc.2.json",
            "docs/evidence/skills-v4.0.0-rc.2.json",
            "docs/evidence/skills-ui-v4.0.0-rc.2.json",
            "docs/evidence/skill-builder-v4.0.0-rc.2.json",
            "docs/evidence/skill-packs-v4.0.0-rc.2.json",
            "docs/evidence/skill-eval-dashboard-v4.0.0-rc.2.json",
            "docs/evidence/skill-versioning-v4.0.0-rc.2.json",
            "docs/evidence/skill-analytics-v4.0.0-rc.2.json",
            "docs/evidence/skill-security-v4.0.0-rc.2.json",
            "docs/evidence/skill-catalog-v4.0.0-rc.2.json",
            "docs/evidence/context-taint-v4.0.0-rc.2.json",
            "docs/evidence/semantic-cache-onnx-v4.0.0-rc.2.json",
            "docs/evidence/rust-sidecar-performance-v4.0.0-rc.2.json",
            "docs/evidence/rag-vector-binary-parity-v4.0.0-rc.2.json",
            "evals/reports/latest.json",
            "evals/reports/agent-latest.json",
            "evals/reports/baseline-compare-latest.json",
            "evals/reports/security-latest.json",
            "evals/reports/skills-v4.0.0-rc.2.json",
            "evals/reports/media-v4.0.0-rc.2.json",
            "evals/reports/browser-v4.0.0-rc.2.json",
            "evals/reports/automation-v4.0.0-rc.2.json",
        )
        for rel in required:
            data = read_json(rel)
    ...
    def test_ga_evidence_shape(self) -> None:
        data = read_json("docs/evidence/ga-v4.0.0-rc.2.json")
