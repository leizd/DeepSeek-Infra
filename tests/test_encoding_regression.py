...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.7.4"', config)
        self.assertIn('versionName "2.7.4"', build_gradle)
        self.assertIn("versionCode 273", build_gradle)
        self.assertIn("version-2.7.4-blue", readme)
    ...
    def test_v273_edge_router_stabilization_is_present(self) -> None:
        ...
        self.assertIn("## [2.7.4] - Edge Router Stabilization", changelog)
        self.assertIn("### v2.7.4: Edge Router Stabilization", readme)
