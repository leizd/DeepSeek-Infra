...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_release_version_sync_current(self) -> None:
        ...
        self.assertIn("version-3.8.0-blue", readme)
        self.assertIn('app_version: str = "3.8.0"', config)
        self.assertIn("deepseek-infra:3.8.0", dockerfile)
        self.assertIn('versionName "3.8.0"', build_gradle)
        self.assertIn("versionCode 380", build_gradle)
        self.assertIn("## [3.8.0] - Rust Sidecar Release Performance & Observability", changelog)
        self.assertIn("Personal AI Runtime GA", readme)
        self.assertIn("python scripts/smoke_ga.py --offline --out docs/evidence/ga-v3.8.0.json", ci)
        self.assertIn("python scripts/preflight_release.py --version 3.8.0 --ga", ci)
    ...
    def test_release_docs_are_registered(self) -> None:
        ...
        self.assertIn("docs/evidence/ga-v3.8.0.json", evidence_index)
        self.assertIn("docs/evidence/ga-v3.8.0.json", manifest)
    ...
    def test_required_evidence_json_is_current_and_passes(self) -> None:
        required = (
            "docs/evidence/ga-v3.8.0.json",
            "docs/evidence/workspace-v3.8.0.json",
            "docs/evidence/edge-router-v3.8.0.json",
            "docs/evidence/media-v3.8.0.json",
            "docs/evidence/browser-v3.8.0.json",
            "docs/evidence/automation-v3.8.0.json",
            "docs/evidence/skills-v3.8.0.json",
            "docs/evidence/skills-ui-v3.8.0.json",
            "docs/evidence/skill-builder-v3.8.0.json",
            "docs/evidence/skill-packs-v3.8.0.json",
            "docs/evidence/skill-eval-dashboard-v3.8.0.json",
            "docs/evidence/skill-versioning-v3.8.0.json",
            "docs/evidence/skill-analytics-v3.8.0.json",
            "docs/evidence/skill-security-v3.8.0.json",
            "docs/evidence/skill-catalog-v3.8.0.json",
            "docs/evidence/context-taint-v3.8.0.json",
            "docs/evidence/semantic-cache-onnx-v3.8.0.json",
            "docs/evidence/rust-sidecar-performance-v3.8.0.json",
            "evals/reports/latest.json",
            "evals/reports/agent-latest.json",
            "evals/reports/baseline-compare-latest.json",
            "evals/reports/security-latest.json",
            "evals/reports/skills-v3.8.0.json",
            "evals/reports/media-v3.8.0.json",
            "evals/reports/browser-v3.8.0.json",
            "evals/reports/automation-v3.8.0.json",
        )
        for rel in required:
            data = read_json(rel)
    ...
    def test_ga_evidence_shape(self) -> None:
        data = read_json("docs/evidence/ga-v3.8.0.json")
