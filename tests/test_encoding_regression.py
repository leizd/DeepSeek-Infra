...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.8.2-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.8.2。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.8.2"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.8.2-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.8.2。", api)
        self.assertIn("适用版本：v2.8.2。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.8.2"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.8.2"', config)
        self.assertIn('versionName "2.8.2"', build_gradle)
        self.assertIn("versionCode 282", build_gradle)
        self.assertIn("version-2.8.2-blue", readme)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.8.2"', build_gradle)
        self.assertIn("versionCode 282", build_gradle)
        self.assertIn("deepseek-infra:2.8.2", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.8.2", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.8.2", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertEqual(evidence["version"], "2.8.2")
    ...
    def test_v241_release_evidence_patch_is_present(self) -> None:
        ...
        self.assertIn("versionCode 282", build_gradle)
        self.assertIn("deepseek-infra:2.8.2", dockerfile)
        self.assertIn("## [2.8.2] - Evidence Index & Manifest Example Sync", changelog)
        ...
        self.assertIn("GARBLED_GLOBS", preflight)
        self.assertIn('"docs/**/*.md"', preflight)
        self.assertIn('"deepseek_infra/**/*.py"', preflight)
        ...
        self.assertEqual(headless_evidence["version"], "2.8.2")
        self.assertEqual(a2a_evidence["version"], "2.8.2")
        self.assertEqual(latest_report["version"], "2.8.2")
        self.assertEqual(agent_report["version"], "2.8.2")
        self.assertEqual(compare_report["version"], "2.8.2")
        self.assertEqual(security_report["version"], "2.8.2")
    ...
    def test_v243_edge_router_evidence_patch_is_present(self) -> None:
        ...
        self.assertIn("Edge Router structured smoke evidence", implementation)
    ...
    def test_v250_workspace_core_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        workspace_evidence = json.loads(Path("docs/evidence/workspace-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Workspace Core Evidence（v2.8.2）", readiness)
        self.assertIn("workspace_core_evidence", evidence_index)
        self.assertIn("docs/evidence/workspace-v2.8.2.json", evidence_index)
        ...
        self.assertIn("docs/evidence/workspace-v2.8.2.json", manifest)
        self.assertIn("smoke_workspace.py --offline --out docs/evidence/workspace-v2.8.2.json", ci)
        self.assertEqual(workspace_evidence["version"], "2.8.2")
    ...
    def test_v263_custom_skill_builder_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skills-v2.8.2.json").read_text(encoding="utf-8"))
        ui_evidence = json.loads(Path("docs/evidence/skills-ui-v2.8.2.json").read_text(encoding="utf-8"))
        builder_evidence = json.loads(Path("docs/evidence/skill-builder-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Applicable version: v2.8.2.", skills_doc)
        ...
        self.assertIn("smoke_skills.py --offline --out docs/evidence/skills-v2.8.2.json", ci)
        self.assertIn("smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v2.8.2.json", ci)
        self.assertIn("smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v2.8.2.json", ci)
        self.assertIn("node --check static/modules/skills.js", ci)
        self.assertIn("docs/evidence/skills-v2.8.2.json", evidence_index)
        self.assertIn("docs/evidence/skills-ui-v2.8.2.json", evidence_index)
        self.assertIn("docs/evidence/skill-builder-v2.8.2.json", evidence_index)
        self.assertIn("Skill System Evidence（v2.8.2）", readiness)
        self.assertIn("Skill Workbench UI Evidence（v2.8.2）", readiness)
        self.assertIn("Skill Builder Evidence (v2.8.2)", readiness)
        self.assertIn("_env_path", config)
        self.assertEqual(evidence["version"], "2.8.2")
        self.assertEqual(evidence["status"], "PASS")
        self.assertEqual(evidence["checks"]["skillApiRoutes"], "PASS")
        self.assertEqual(ui_evidence["version"], "2.8.2")
        ...
        self.assertEqual(builder_evidence["version"], "2.8.2")
        ...
        self.assertEqual(skill_eval["version"], "2.8.2")
    ...
    def test_v264_skill_packs_is_present(self) -> None:
        ...
        styles = Path("static/styles.css").read_text(encoding="utf-8")
        build_gradle = Path("android/app/build.gradle").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-packs-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("skill-packs-v2.8.2.json", manifest)
        self.assertIn("smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v2.8.2.json", ci)
        self.assertIn("node --check static/modules/skills.js", ci)
        ...
        self.assertIn("docs/evidence/skill-packs-v2.8.2.json", evidence_index)
        self.assertIn("scripts/smoke_skill_packs.py", evidence_index)
        self.assertIn("Skill Packs Evidence (v2.8.2)", readiness)
    ...
    def test_v265_skill_eval_dashboard_is_present(self) -> None:
        ...
        styles = Path("static/styles.css").read_text(encoding="utf-8")
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-eval-dashboard-v2.8.2.json").read_text(encoding="utf-8"))
        report = json.loads(Path("evals/reports/skills-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Skill eval report is `evals/reports/skills-v2.8.2.json`", skills_doc)
        ...
        self.assertIn("evals/reports/skills-v2.8.2.json", manifest)
        self.assertIn("smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v2.8.2.json", ci)
        ...
        self.assertIn("docs/evidence/skill-eval-dashboard-v2.8.2.json", evidence_index)
        ...
        self.assertEqual(report["version"], "2.8.2")
    ...
    def test_v266_skill_versioning_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-versioning-v2.8.2.json").read_text(encoding="utf-8"))
    ...
    def test_v267_skill_run_analytics_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-analytics-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("docs/evidence/skill-analytics-v2.8.2.json", manifest)
        self.assertIn("smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v2.8.2.json", ci)
        ...
        self.assertIn("docs/evidence/skill-analytics-v2.8.2.json", evidence_index)
    ...
    def test_v268_skill_security_review_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-security-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("docs/evidence/skill-security-v2.8.2.json", manifest)
        self.assertIn("smoke_skill_security.py --offline --out docs/evidence/skill-security-v2.8.2.json", ci)
        ...
        self.assertIn("docs/evidence/skill-security-v2.8.2.json", evidence_index)
    ...
    def test_v269_local_skill_catalog_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-catalog-v2.8.2.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("docs/evidence/skill-catalog-v2.8.2.json", manifest)
        self.assertIn("smoke_skill_catalog.py --offline --out docs/evidence/skill-catalog-v2.8.2.json", ci)
        ...
        self.assertIn("docs/evidence/skill-catalog-v2.8.2.json", evidence_index)
    ...
    def test_v273_edge_router_stabilization_is_present(self) -> None:
        readme = Path("README.md").read_text(encoding="utf-8")
        changelog = Path("CHANGELOG.md").read_text(encoding="utf-8")
        dockerfile = Path("Dockerfile").read_text(encoding="utf-8")
        preflight = Path("scripts/preflight_release.py").read_text(encoding="utf-8")
        ...
        self.assertIn("## [2.7.3] - Edge Router Stabilization", changelog)
        self.assertIn("### v2.7.3: Edge Router Stabilization", readme)
        self.assertIn("## [2.7.2] - Release Hygiene & Encoding Gates", changelog)
        self.assertIn("### v2.7.2: Release Hygiene & Encoding Gates", readme)
        self.assertIn("version-2.8.2-blue", readme)
        self.assertIn("deepseek-infra:2.8.2", dockerfile)
        self.assertIn("# DeepSeek Infra - local-first agentic AI runtime", dockerfile)
        for marker in ("\u9225", "\u93cb", "\u6769", "\u951f\u65a4\u62f7", "???"):
            self.assertNotIn(marker, dockerfile)
        self.assertIn("GARBLED_EXACT_PATHS", preflight)
        self.assertIn("GARBLED_GLOBS", preflight)
        self.assertIn('"Dockerfile"', preflight)
        self.assertIn('".github/workflows/*.yml"', preflight)
        self.assertIn('"scripts/*.py"', preflight)
        self.assertIn('"docs/**/*.md"', preflight)
        self.assertIn("_encoding_scan_paths", preflight)
        self.assertIn("workflow_dispatch:", ci)
        self.assertIn("branches: [main]", ci)
        self.assertIn("Edge Router Stabilization", readiness)
        self.assertIn("edge_router_evidence", preflight)
        self.assertIn("smoke_edge_router.py --offline --out docs/evidence/edge-router-v2.8.2.json", ci)
        self.assertIn("MVP, dry-run release gated", implementation)
        self.assertIn("/api/edge/route-preview", api_doc)
        self.assertIn("EDGE_PROVIDER", runbook)
        self.assertIn("edgeRouter", manifest)
        for command in (
            "python scripts/smoke_release.py --offline",
            "python scripts/preflight_release.py --version 2.8.2",
            "docker build -t deepseek-infra:2.8.2 .",
            "python scripts/release.py --clean-workspace --version 2.8.2",
        ):
            self.assertIn(command, checklist)
        self.assertTrue(Path("tests/test_preflight_encoding_scope.py").is_file())

    def test_v270_multimodal_media_layer_is_present(self) -> None:
        readme = Path("README.md").read_text(encoding="utf-8")
        changelog = Path("CHANGELOG.md").read_text(encoding="utf-8")
        media_doc = Path("docs/MEDIA.md").read_text(encoding="utf-8")
        evidence_index = Path("docs/EVIDENCE_INDEX.md").read_text(encoding="utf-8")
        readiness = Path("docs/RELEASE_READINESS.md").read_text(encoding="utf-8")
        implementation = Path("docs/IMPLEMENTATION_STATUS.md").read_text(encoding="utf-8")
        server = Path("deepseek_infra/web/server.py").read_text(encoding="utf-8")
        media_route = Path("deepseek_infra/web/routes/media.py").read_text(encoding="utf-8")
        media_library = Path("deepseek_infra/infra/media/library.py").read_text(encoding="utf-8")
        media_indexer = Path("deepseek_infra/infra/media/indexer.py").read_text(encoding="utf-8")
        skill_runner = Path("deepseek_infra/infra/skills/runner.py").read_text(encoding="utf-8")
        smoke = Path("scripts/smoke_media.py").read_text(encoding="utf-8")
        eval_runner = Path("evals/runners/run_media_eval.py").read_text(encoding="utf-8")
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/media-v2.8.2.json").read_text(encoding="utf-8"))
        report = json.loads(Path("evals/reports/media-v2.8.2.json").read_text(encoding="utf-8"))

        self.assertIn("## [2.7.0] - Multimodal Media Layer", changelog)
        self.assertIn("### v2.7.0: Multimodal Media Layer", readme)
        self.assertIn("media a first-class workspace object", media_doc)
        self.assertIn("POST /api/media", media_doc)
        self.assertIn("Media Layer Evidence", implementation)
        self.assertIn("Media Layer Evidence", readiness)
        self.assertIn("docs/evidence/media-v2.8.2.json", evidence_index)
        self.assertIn("evals/reports/media-v2.8.2.json", evidence_index)
        self.assertIn("create_media_router", server)
        self.assertIn("@router.post(\"/api/media\")", media_route)
        self.assertIn("register_media", media_library)
        self.assertIn("COLLECTION_MEDIA", media_indexer)
        self.assertIn("_media_context", skill_runner)
        self.assertIn("imageImport", smoke)
        self.assertIn("mediaRecall", eval_runner)
        self.assertIn("mediaLayer", manifest)
        self.assertIn("smoke_media.py --offline --out docs/evidence/media-v2.8.2.json", ci)
        self.assertIn("run_media_eval.py --out evals/reports/media-v2.8.2.json --strict", ci)
        for skill_id in (
            "image_explainer",
            "pdf_reader",
            "webpage_summarizer",
            ...
            self.assertTrue(Path("skills/builtin", f"{skill_id}.json").is_file())
        self.assertEqual(evidence["version"], "2.8.2")
        self.assertEqual(evidence["status"], "PASS")
        for check in (
            "imageImport",
