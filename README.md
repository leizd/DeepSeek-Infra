...
> Rust core migration is now in the 3.3.2 pre-4.0 readiness track. [ADR-0040](docs/adr/ADR-0040-hybrid-runtime-architecture.md) approves a Python-first hybrid 4.0 architecture: Python FastAPI remains the default runtime, all Rust delegates remain opt-in, and Python fallback is supported throughout 4.x. Two consecutive full suites measured 95.3428% and 95.3396%, so the repository is **ready for 4.0.0-rc.1** with a 95% CI gate. Branch coverage is recorded without a separate blocking threshold. This milestone proves readiness but does not create an RC tag. See [the 4.0 RC readiness matrix](docs/4_0_RC_READINESS.md).
...
**Release preflight (v3.3.0)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_ga.py --offline --out docs/evidence/ga-v3.3.0.json`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v3.3.0.json`, `python scripts/smoke_edge_router.py --offline --out docs/evidence/edge-router-v3.3.0.json`, `python scripts/smoke_media.py --offline --out docs/evidence/media-v3.3.0.json`, `python scripts/smoke_browser.py --offline --out docs/evidence/browser-v3.3.0.json --version 3.3.0`, `python scripts/smoke_automation.py --offline --out docs/evidence/automation-v3.3.0.json --version 3.3.0`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v3.3.0.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v3.3.0.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v3.3.0.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v3.3.0.json`, `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v3.3.0.json --report-out evals/reports/skills-v3.3.0.json`, `python scripts/smoke_skill_versioning.py --offline --out docs/evidence/skill-versioning-v3.3.0.json`, `python scripts/smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v3.3.0.json`, `python scripts/smoke_skill_security.py --offline --out docs/evidence/skill-security-v3.3.0.json`, `python scripts/smoke_skill_catalog.py --offline --out docs/evidence/skill-catalog-v3.3.0.json`, `python scripts/smoke_context_taint.py --offline --out docs/evidence/context-taint-v3.3.0.json`, and `python evals/runners/run_media_eval.py --strict --out evals/reports/media-v3.3.0.json`, and `python evals/runners/run_browser_eval.py --strict --out evals/reports/browser-v3.3.0.json --version 3.3.0`, and `python evals/runners/run_automation_eval.py --strict --out evals/reports/automation-v3.3.0.json --version 3.3.0`; then run `python scripts/preflight_release.py --version 3.3.0 --ga` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `edgeRouter`, `workspaceCore`, `mediaLayer`, `browserControl`, `automationRuntime`, `contextTaint`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, `skillEvalDashboard`, `skillVersioning`, `skillAnalytics`, `skillSecurity`, and `skillCatalog`.
