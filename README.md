...
![版本](https://img.shields.io/badge/version-2.6.5-blue)
...
**Release preflight (v2.6.5)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v2.6.5.json`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v2.6.5.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v2.6.5.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v2.6.5.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v2.6.5.json`, and `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v2.6.5.json --report-out evals/reports/skills-v2.6.5.json`; then run `python scripts/preflight_release.py --version 2.6.5` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `workspaceCore`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, and `skillEvalDashboard`.
...
- [x] Add `scripts/smoke_skill_eval_dashboard.py --offline`, `evals/reports/skills-v2.6.5.json`, and `docs/evidence/skill-eval-dashboard-v2.6.5.json`.
