...
![版本](https://img.shields.io/badge/version-2.7.4-blue)
...
**Release preflight (v2.7.4)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v2.7.4.json`, `python scripts/smoke_edge_router.py --offline --out docs/evidence/edge-router-v2.7.4.json`, `python scripts/smoke_media.py --offline --out docs/evidence/media-v2.7.4.json`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v2.7.4.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v2.7.4.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v2.7.4.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v2.7.4.json`, `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v2.7.4.json --report-out evals/reports/skills-v2.7.4.json`, `python scripts/smoke_skill_versioning.py --offline --out docs/evidence/skill-versioning-v2.7.4.json`, `python scripts/smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v2.7.4.json`, `python scripts/smoke_skill_security.py --offline --out docs/evidence/skill-security-v2.7.4.json`, `python scripts/smoke_skill_catalog.py --offline --out docs/evidence/skill-catalog-v2.7.4.json`, `python scripts/smoke_context_taint.py --offline --out docs/evidence/context-taint-v2.7.4.json`, and `python evals/runners/run_media_eval.py --strict --out evals/reports/media-v2.7.4.json`; then run `python scripts/preflight_release.py --version 2.7.4` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `edgeRouter`, `workspaceCore`, `mediaLayer`, `contextTaint`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, `skillEvalDashboard`, `skillVersioning`, `skillAnalytics`, `skillSecurity`, and `skillCatalog`.
