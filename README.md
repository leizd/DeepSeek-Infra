...
3.4.0 extends the existing opt-in RAG delegate with `POST /rag/vectors/rank`. Semantic-cache candidate vectors can be ranked in Rust while cache storage, expiry, scoping, thresholds, and exact-match handling stay in Python. Invalid or unavailable sidecar responses fall back to the original Python scan. The selection rationale and deferred candidates are documented in [the 3.4.0 Rust candidate audit](docs/RUST_CANDIDATE_AUDIT_3_4.md).
...
**Release preflight (v3.4.0)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_ga.py --offline --out docs/evidence/ga-v3.4.0.json`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v3.4.0.json`, `python scripts/smoke_edge_router.py --offline --out docs/evidence/edge-router-v3.4.0.json`, `python scripts/smoke_media.py --offline --out docs/evidence/media-v3.4.0.json`, `python scripts/smoke_browser.py --offline --out docs/evidence/browser-v3.4.0.json --version 3.4.0`, `python scripts/smoke_automation.py --offline --out docs/evidence/automation-v3.4.0.json --version 3.4.0`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v3.4.0.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v3.4.0.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v3.4.0.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v3.4.0.json`, `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v3.4.0.json --report-out evals/reports/skills-v3.4.0.json`, `python scripts/smoke_skill_versioning.py --offline --out docs/evidence/skill-versioning-v3.4.0.json`, `python scripts/smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v3.4.0.json`, `python scripts/smoke_skill_security.py --offline --out docs/evidence/skill-security-v3.4.0.json`, `python scripts/smoke_skill_catalog.py --offline --out docs/evidence/skill-catalog-v3.4.0.json`, `python scripts/smoke_context_taint.py --offline --out docs/evidence/context-taint-v3.4.0.json`, and `python evals/runners/run_media_eval.py --strict --out evals/reports/media-v3.4.0.json`, and `python evals/runners/run_browser_eval.py --strict --out evals/reports/browser-v3.4.0.json --version 3.4.0`, and `python evals/runners/run_automation_eval.py --strict --out evals/reports/automation-v3.4.0.json --version 3.4.0`; then run `python scripts/preflight_release.py --version 3.4.0 --ga` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `edgeRouter`, `workspaceCore`, `mediaLayer`, `browserControl`, `automationRuntime`, `contextTaint`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, `skillEvalDashboard`, `skillVersioning`, `skillAnalytics`, `skillSecurity`, and `skillCatalog`.
