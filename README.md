...
![版本](https://img.shields.io/badge/version-4.0.0-rc.1-blue)
![Python](https://img.shields.io/badge/python-3.10%2B-green)
![Coverage Gate](https://img.shields.io/badge/coverage%20gate-95%25-brightgreen)
![许可证](https://img.shields.io/badge/license-MIT-black)

> **4.0.0-rc.1 prerelease:** this release candidate freezes the readiness-approved Python-first hybrid runtime with a 95% statement-and-branch coverage gate. Python remains the default runtime, all four Rust delegates remain opt-in, default Compose remains Python-only, and Python fallback is supported throughout 4.x. It is intended for release-candidate testing and does not replace the latest stable production release. See [the RC release notes](docs/releases/4.0.0-rc.1.md), [ADR-0040](docs/adr/ADR-0040-hybrid-runtime-architecture.md), and [the readiness matrix](docs/4_0_RC_READINESS.md).
...
**Release preflight (v4.0.0-rc.1)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_ga.py --offline --out docs/evidence/ga-v4.0.0-rc.1.json`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v4.0.0-rc.1.json`, `python scripts/smoke_edge_router.py --offline --out docs/evidence/edge-router-v4.0.0-rc.1.json`, `python scripts/smoke_media.py --offline --out docs/evidence/media-v4.0.0-rc.1.json`, `python scripts/smoke_browser.py --offline --out docs/evidence/browser-v4.0.0-rc.1.json --version 4.0.0-rc.1`, `python scripts/smoke_automation.py --offline --out docs/evidence/automation-v4.0.0-rc.1.json --version 4.0.0-rc.1`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v4.0.0-rc.1.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v4.0.0-rc.1.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v4.0.0-rc.1.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v4.0.0-rc.1.json`, `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v4.0.0-rc.1.json --report-out evals/reports/skills-v4.0.0-rc.1.json`, `python scripts/smoke_skill_versioning.py --offline --out docs/evidence/skill-versioning-v4.0.0-rc.1.json`, `python scripts/smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v4.0.0-rc.1.json`, `python scripts/smoke_skill_security.py --offline --out docs/evidence/skill-security-v4.0.0-rc.1.json`, `python scripts/smoke_skill_catalog.py --offline --out docs/evidence/skill-catalog-v4.0.0-rc.1.json`, `python scripts/smoke_context_taint.py --offline --out docs/evidence/context-taint-v4.0.0-rc.1.json`, and `python evals/runners/run_media_eval.py --strict --out evals/reports/media-v4.0.0-rc.1.json`, and `python evals/runners/run_browser_eval.py --strict --out evals/reports/browser-v4.0.0-rc.1.json --version 4.0.0-rc.1`, and `python evals/runners/run_automation_eval.py --strict --out evals/reports/automation-v4.0.0-rc.1.json --version 4.0.0-rc.1`; then run `python scripts/preflight_release.py --version 4.0.0-rc.1 --ga` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `edgeRouter`, `workspaceCore`, `mediaLayer`, `browserControl`, `automationRuntime`, `contextTaint`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, `skillEvalDashboard`, `skillVersioning`, `skillAnalytics`, `skillSecurity`, and `skillCatalog`.
