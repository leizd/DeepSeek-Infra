...
EVIDENCE_SPECS = (
    ...
    EvidenceSpec(
        "docs/evidence/federation-trust-proof-v{version}.json",
        "storage-control-plane-minio-e2e",
        "exact-merge",
        payload_kind="proof",
        scenario="real-two-fleet-four-minio-signed-federation-trust",
        required_checks=FEDERATION_TRUST_REQUIRED_CHECKS,
    ),
    EvidenceSpec(
        "docs/evidence/federated-replica-proof-v{version}.json",
        "storage-control-plane-minio-e2e",
        "exact-merge",
        payload_kind="proof",
        scenario="real-two-fleet-four-minio-signed-federation-replica",
        required_checks=(*FEDERATED_REPLICA_REQUIRED_CHECKS, *FEDERATION_RUNTIME_REQUIRED_CHECKS),
    ),
    EvidenceSpec(
        "docs/evidence/federated-dr-proof-v{version}.json",
        "storage-control-plane-minio-e2e",
        "exact-merge",
        payload_kind="proof",
        scenario="real-two-fleet-four-minio-signed-federation-dr",
        required_checks=FEDERATED_DR_REQUIRED_CHECKS,
    ),
