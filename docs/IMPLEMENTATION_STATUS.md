...
| Release Readiness（发版体检 / 产物证明） | [scripts/doctor.py](../scripts/doctor.py) · [scripts/preflight_release.py](../scripts/preflight_release.py) · [scripts/smoke_release.py](../scripts/smoke_release.py) · [scripts/check_4_0_rc_readiness.py](../scripts/check_4_0_rc_readiness.py) · [docs/4_0_RC_READINESS.md](4_0_RC_READINESS.md) | ✅ 3.8.0: 2,490 Python tests + 58 subtests at 95.35% combined statement-and-branch coverage, 155 Rust tests, 68/68 Gateway parity, 105/105 MCP parity, 38/38 existing RAG parity, and 125/125 RAG document-preparation parity. HIGH-risk debt remains 201 missing statements / 198 missing branches; Python-first defaults remain unchanged. The published 4.0.0-rc.1 is historical and this work creates no tag or release. |
