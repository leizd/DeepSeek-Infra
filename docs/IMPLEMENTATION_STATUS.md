...
| 14 | Rust Core Hybrid Runtime | MVP, default-disabled; 3.4.0 adds semantic-cache vector ranking with Python fallback; NOT READY for 4.0.0-rc.1 due to coverage | ✅ [infra/rust_core/](../deepseek_infra/infra/rust_core/) · [rust/](../rust/) | ✅ | ✅ [RUST_CANDIDATE_AUDIT_3_4.md](RUST_CANDIDATE_AUDIT_3_4.md) · [RUST_HYBRID_RUNTIME_RUNBOOK.md](RUST_HYBRID_RUNTIME_RUNBOOK.md) · [ADR-0040](adr/ADR-0040-hybrid-runtime-architecture.md) · [4_0_RC_READINESS.md](4_0_RC_READINESS.md) |
...
| Release Readiness（发版体检 / 产物证明） | [scripts/doctor.py](../scripts/doctor.py) · [scripts/preflight_release.py](../scripts/preflight_release.py) · [scripts/smoke_release.py](../scripts/smoke_release.py) · [scripts/check_4_0_rc_readiness.py](../scripts/check_4_0_rc_readiness.py) · [docs/4_0_RC_READINESS.md](4_0_RC_READINESS.md) | ✅ The 3.4.0 checker validates ADR-0040 from a machine-readable decision file. All five architecture decisions pass; current verdict remains NOT READY solely because measured Python coverage is below 95.00%. |
