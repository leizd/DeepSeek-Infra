...
python scripts/check_mcp_protocol_parity.py \
  ...
  --strict \
  --report docs/evidence/mcp-protocol-parity-v4.0.3.json
```
...
The `mcp-protocol-parity` CI job uploads `docs/evidence/mcp-protocol-parity-v4.0.3.json` even when the gate fails.
