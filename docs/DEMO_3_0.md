...
```bash
python scripts/smoke_ga.py --offline --out docs/evidence/ga-v4.0.0-rc.2.json --json
```
...
Primary evidence: `docs/evidence/ga-v4.0.0-rc.2.json`.

Release gate:

```bash
python scripts/preflight_release.py --version 4.0.0-rc.2 --ga
```
