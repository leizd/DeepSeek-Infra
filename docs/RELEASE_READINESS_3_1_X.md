...
| General availability | `scripts/smoke_ga.py` | `docs/evidence/ga-v4.0.0-rc.1.json` |
| Workspace | `scripts/smoke_workspace.py` | `docs/evidence/workspace-v4.0.0-rc.1.json` |
| Edge router | `scripts/smoke_edge_router.py` | `docs/evidence/edge-router-v4.0.0-rc.1.json` |
| Media | `scripts/smoke_media.py` | `docs/evidence/media-v4.0.0-rc.1.json` |
| Browser | `scripts/smoke_browser.py` | `docs/evidence/browser-v4.0.0-rc.1.json` |
| Automation | `scripts/smoke_automation.py` | `docs/evidence/automation-v4.0.0-rc.1.json` |
| Skills | `scripts/smoke_skills.py` | `docs/evidence/skills-v4.0.0-rc.1.json` |
| Skills UI | `scripts/smoke_skills_ui.py` | `docs/evidence/skills-ui-v4.0.0-rc.1.json` |
| Skill builder | `scripts/smoke_skill_builder.py` | `docs/evidence/skill-builder-v4.0.0-rc.1.json` |
| Skill packs | `scripts/smoke_skill_packs.py` | `docs/evidence/skill-packs-v4.0.0-rc.1.json` |
| Skill eval dashboard | `scripts/smoke_skill_eval_dashboard.py` | `docs/evidence/skill-eval-dashboard-v4.0.0-rc.1.json` |
| Skill versioning | `scripts/smoke_skill_versioning.py` | `docs/evidence/skill-versioning-v4.0.0-rc.1.json` |
| Skill analytics | `scripts/smoke_skill_analytics.py` | `docs/evidence/skill-analytics-v4.0.0-rc.1.json` |
| Skill security | `scripts/smoke_skill_security.py` | `docs/evidence/skill-security-v4.0.0-rc.1.json` |
| Skill catalog | `scripts/smoke_skill_catalog.py` | `docs/evidence/skill-catalog-v4.0.0-rc.1.json` |
| Context taint | `scripts/smoke_context_taint.py` | `docs/evidence/context-taint-v4.0.0-rc.1.json` |
