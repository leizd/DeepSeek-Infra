...
| General availability | `scripts/smoke_ga.py` | `docs/evidence/ga-v3.9.0.json` |
| Workspace | `scripts/smoke_workspace.py` | `docs/evidence/workspace-v3.9.0.json` |
| Edge router | `scripts/smoke_edge_router.py` | `docs/evidence/edge-router-v3.9.0.json` |
| Media | `scripts/smoke_media.py` | `docs/evidence/media-v3.9.0.json` |
| Browser | `scripts/smoke_browser.py` | `docs/evidence/browser-v3.9.0.json` |
| Automation | `scripts/smoke_automation.py` | `docs/evidence/automation-v3.9.0.json` |
| Skills | `scripts/smoke_skills.py` | `docs/evidence/skills-v3.9.0.json` |
| Skills UI | `scripts/smoke_skills_ui.py` | `docs/evidence/skills-ui-v3.9.0.json` |
| Skill builder | `scripts/smoke_skill_builder.py` | `docs/evidence/skill-builder-v3.9.0.json` |
| Skill packs | `scripts/smoke_skill_packs.py` | `docs/evidence/skill-packs-v3.9.0.json` |
| Skill eval dashboard | `scripts/smoke_skill_eval_dashboard.py` | `docs/evidence/skill-eval-dashboard-v3.9.0.json` |
| Skill versioning | `scripts/smoke_skill_versioning.py` | `docs/evidence/skill-versioning-v3.9.0.json` |
| Skill analytics | `scripts/smoke_skill_analytics.py` | `docs/evidence/skill-analytics-v3.9.0.json` |
| Skill security | `scripts/smoke_skill_security.py` | `docs/evidence/skill-security-v3.9.0.json` |
| Skill catalog | `scripts/smoke_skill_catalog.py` | `docs/evidence/skill-catalog-v3.9.0.json` |
| Context taint | `scripts/smoke_context_taint.py` | `docs/evidence/context-taint-v3.9.0.json` |
