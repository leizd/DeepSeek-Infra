...
```bash
python evals/runners/run_skill_eval.py --strict --out evals/reports/skills-v2.8.1.json
python evals/runners/run_skill_eval.py --scope skill --skill-id skill_study_tutor --out evals/reports/skills-v2.8.1.json
python evals/runners/run_skill_eval.py --scope pack --pack-id pack_study --out evals/reports/skills-v2.8.1.json
python evals/runners/run_skill_eval.py --baseline evals/reports/skills-v2.6.4.json --out evals/reports/skills-v2.8.1.json
```
...
发布 evidence 文件为 `docs/evidence/skills-v2.8.1.json`。
Skill Workbench UI evidence 文件为 `docs/evidence/skills-ui-v2.8.1.json`。
自定义 Skill Builder evidence 文件为 `docs/evidence/skill-builder-v2.8.1.json`。
Skill Packs evidence 文件为 `docs/evidence/skill-packs-v2.8.1.json`。
Skill Eval Dashboard evidence 文件为 `docs/evidence/skill-eval-dashboard-v2.8.1.json`。
Skill Versioning evidence 文件为 `docs/evidence/skill-versioning-v2.8.1.json`。
Skill Analytics evidence 文件为 `docs/evidence/skill-analytics-v2.8.1.json`。
Skill Security evidence 文件为 `docs/evidence/skill-security-v2.8.1.json`。
Skill Catalog evidence 文件为 `docs/evidence/skill-catalog-v2.8.1.json`。
Skill eval 报告为 `evals/reports/skills-v2.8.1.json`。
Skill eval report is `evals/reports/skills-v2.8.1.json`.
