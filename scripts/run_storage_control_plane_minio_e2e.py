...
CHECK_SCENARIOS = {
    ...
    "longRunningWaveRenewsScheduleLease": AUTONOMOUS_REMEDIATION_SCENARIO,
    "longRunningWaveRenewsWaveLease": AUTONOMOUS_REMEDIATION_SCENARIO,
    "realProcessWaveSigkillTakeoverUsesHigherEpoch": AUTONOMOUS_REMEDIATION_SCENARIO,
    "realProcessWaveSigkillDoesNotDuplicateEffect": AUTONOMOUS_REMEDIATION_SCENARIO,
    "realProcessWaveSigkillSettlesExactlyOnce": AUTONOMOUS_REMEDIATION_SCENARIO,
    ...
    "absentAuthoritativeRiskIsClosedOrRetired": PREDICTIVE_FLEET_SCENARIO,
    "supersededBackupRiskCannotRemainOpenForever": PREDICTIVE_FLEET_SCENARIO,
    "policyDisabledRiskIsRetired": PREDICTIVE_FLEET_SCENARIO,
    "unknownCoverageDoesNotImplicitlyClearRisk": PREDICTIVE_FLEET_SCENARIO,
    "schedulerReservationDoesNotCountAsConsumedService": PREDICTIVE_FLEET_SCENARIO,
    "preemptedActionReleasesFairnessReservation": PREDICTIVE_FLEET_SCENARIO,
    "completedActionChargesObservedBytesExactlyOnce": PREDICTIVE_FLEET_SCENARIO,
    "serviceConsumptionSurvivesRestart": PREDICTIVE_FLEET_SCENARIO,
    "waveOneCannotStartBeforeWaveZeroVerified": PREDICTIVE_FLEET_SCENARIO,
    "failedWavePausesDownstreamActions": PREDICTIVE_FLEET_SCENARIO,
    "staleWaveRequiresReplan": PREDICTIVE_FLEET_SCENARIO,
    "waveRevalidatesFreshRiskBeforeExecution": PREDICTIVE_FLEET_SCENARIO,
    "waveRevalidatesAuthorityBeforeExecution": PREDICTIVE_FLEET_SCENARIO,
    "waveRevalidatesBlastRadiusBeforeExecution": PREDICTIVE_FLEET_SCENARIO,
    "fleetSloExposes1h24h7d30dWindows": PREDICTIVE_FLEET_SCENARIO,
    "insufficientSloSamplesAreExplicit": PREDICTIVE_FLEET_SCENARIO,
    "capacityForecastUsesDurableObservations": PREDICTIVE_FLEET_SCENARIO,
    "forecastWithInsufficientSamplesFailsClosed": PREDICTIVE_FLEET_SCENARIO,
    "thirtyDayCapacityForecastProduced": PREDICTIVE_FLEET_SCENARIO,
    "ninetyDayCapacityForecastProduced": PREDICTIVE_FLEET_SCENARIO,
    "forecastProvidesP50AndP90Headroom": PREDICTIVE_FLEET_SCENARIO,
    "forecastBacktestErrorIsPersisted": PREDICTIVE_FLEET_SCENARIO,
    "overoptimisticForecastLowersConfidence": PREDICTIVE_FLEET_SCENARIO,
    "costModelUsesVersionedPriceCatalog": PREDICTIVE_FLEET_SCENARIO,
    "unknownTargetPriceDoesNotBecomeZero": PREDICTIVE_FLEET_SCENARIO,
    "egressCostIsIncluded": PREDICTIVE_FLEET_SCENARIO,
    "storageCostIsIncluded": PREDICTIVE_FLEET_SCENARIO,
    "optimizerNeverReducesMinCommittedCopies": PREDICTIVE_FLEET_SCENARIO,
    "optimizerNeverReducesMinFailureDomains": PREDICTIVE_FLEET_SCENARIO,
    "optimizerRejectsUnsafeCheaperPlan": PREDICTIVE_FLEET_SCENARIO,
    "candidatePlanIsDeterministicForSameInputs": PREDICTIVE_FLEET_SCENARIO,
    "whatIfProducesNoStorageWrites": PREDICTIVE_FLEET_SCENARIO,
    "whatIfProducesNoStorageDeletes": PREDICTIVE_FLEET_SCENARIO,
    "whatIfDoesNotMutateAuthority": PREDICTIVE_FLEET_SCENARIO,
    "whatIfDoesNotMutateActionJournal": PREDICTIVE_FLEET_SCENARIO,
    "whatIfBindsObservedFleetSnapshot": PREDICTIVE_FLEET_SCENARIO,
    "whatIfIncludesRunningEffects": PREDICTIVE_FLEET_SCENARIO,
    "whatIfIncludesMaintenanceWindows": PREDICTIVE_FLEET_SCENARIO,
    "optimizationProofBindsForecastDigest": PREDICTIVE_FLEET_SCENARIO,
    "optimizationProofBindsPriceCatalogDigest": PREDICTIVE_FLEET_SCENARIO,
    "optimizationProofBindsAuthorityHead": PREDICTIVE_FLEET_SCENARIO,
    "optimizationProofRecomputesSafetyConstraints": PREDICTIVE_FLEET_SCENARIO,
    "federationSnapshotContainsNoCredentials": PREDICTIVE_FLEET_SCENARIO,
