...
CORPUS_MANIFESTS = (
    ...
    ROOT / "compat" / "native-runtime" / "v20" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v21" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v22" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v23" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v24" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v25" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v26" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v27" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v28" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v29" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v30" / "manifest.json",
    ROOT / "compat" / "native-runtime" / "v31" / "manifest.json",
)
