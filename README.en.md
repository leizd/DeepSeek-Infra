...
- `/` remains the stable vanilla-JavaScript workspace.
- `/ui/` hosts the isolated React + TypeScript normal-chat vertical slice.
...
See the [4.0.3 release notes](docs/releases/4.0.3.md), [frontend boundaries](docs/FRONTEND_MODULES.md), [upgrade guidance](docs/UPGRADING_TO_4_0.md), and [support policy](docs/4_0_SUPPORT_POLICY.md).
