...
# Build: docker build -t deepseek-infra:4.4.9 .
# Run: docker run --rm -p 127.0.0.1:8000:8000 --env-file .env -v deepseek-data:/data deepseek-infra:4.4.9
...
LABEL org.opencontainers.image.title="DeepSeek Infra" \
      org.opencontainers.image.version="4.4.9" \
