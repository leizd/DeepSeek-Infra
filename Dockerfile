...
# Build: docker build -t deepseek-infra:4.0.0-rc.2 .
# Run: docker run --rm -p 127.0.0.1:8000:8000 --env-file .env -v deepseek-data:/data deepseek-infra:4.0.0-rc.2
# See docs/DEPLOYMENT.md for deployment notes.
FROM python:3.12-slim

ARG VCS_REF=unknown
LABEL org.opencontainers.image.title="DeepSeek Infra" \
      org.opencontainers.image.version="4.0.0-rc.2" \
