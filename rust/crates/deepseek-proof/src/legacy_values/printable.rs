//! Python Unicode 15.1 printability, from the Python 3.13 offline oracle.
//! Rust debug formatting also escapes grapheme extenders and follows Rust's Unicode
//! version, neither of which matches Python repr. No Python runtime is needed here.
...
pub(super) fn is_printable(character: char) -> bool {
    ...
    let index = NON_PRINTABLE.partition_point(|(_, end)| *end < codepoint);
    NON_PRINTABLE
        .get(index)
        .is_none_or(|(start, _)| codepoint < *start)
}

// Coalesced, sorted exclusion ranges; keep the generated data compact.
#[rustfmt::skip]
const NON_PRINTABLE: &[(u32, u32)] = &[
    ...
    (0x85f, 0x85f), (0x86b, 0x86f), (0x88f, 0x897), (0x8e2, 0x8e2),
    ...
    (0x1acf, 0x1aff), (0x1b4d, 0x1b4f), (0x1b7f, 0x1b7f), (0x1bf4, 0x1bfb),
    ...
    (0x1ff5, 0x1ff5), (0x1fff, 0x200f), (0x2028, 0x202f), (0x205f, 0x206f),
    ...
    (0x2fd6, 0x2fef), (0x3000, 0x3000), (0x3040, 0x3040), (0x3097, 0x3098),
    (0x3100, 0x3104), (0x3130, 0x3130), (0x318f, 0x318f), (0x31e4, 0x31ee),
    ...
    (0x1e4fa, 0x1e7df), (0x1e7e7, 0x1e7e7), (0x1e7ec, 0x1e7ec), (0x1e7ef, 0x1e7ef),
    ...
    (0x1fa6e, 0x1fa6f), (0x1fa7d, 0x1fa7f), (0x1fa89, 0x1fa8f), (0x1fabe, 0x1fabe),
    (0x1fac6, 0x1facd), (0x1fadc, 0x1fadf), (0x1fae9, 0x1faef), (0x1faf9, 0x1faff),
    (0x1fb93, 0x1fb93), (0x1fbcb, 0x1fbef), (0x1fbfa, 0x1ffff), (0x2a6e0, 0x2a6ff),
...
mod tests {
    ...
    #[test]
    fn every_unicode_codepoint_matches_the_frozen_python_printability_bitmap() {
        assert_eq!(NON_PRINTABLE.len(), 713);
        assert!(
            NON_PRINTABLE
                .windows(2)
        ...
        for codepoint in 0..=0x10ffff {
            let printable = char::from_u32(codepoint).is_some_and(is_printable);
            digest.update([u8::from(printable)]);
        }
        // SHA-256 of one boolean byte per codepoint, 0 through 0x10ffff inclusive.
        // The offline Python oracle also classifies lone surrogates as non-printable.
        assert_eq!(
