use deepseek_worker::{MutationRequestContext, verify_mutation_request_document};
...
fn fixture() -> Fixture {
    serde_json::from_str(include_str!(concat!(
        ...
        "/../../../compat/native-runtime/v17/control/mutation_request_vector.json"
    )))
    .unwrap()
}
...
#[test]
fn rust_accepts_the_frozen_mutation_request() {
    let fixture = fixture();
    let empty = Value::Object(Map::new());
    let verified = verify_mutation_request_document(
    ...
    assert_eq!(
        ...
        Some("propose-mutation")
    );
}

#[test]
fn rust_rejects_frozen_mutation_request_failures() {
    let fixture = fixture();
    for case in &fixture.cases {
        ...
        let error = verify_mutation_request_document(&raw, &context(&fixture, &case.context))
